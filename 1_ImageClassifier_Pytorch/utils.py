...
def train_model(net, dataloader_dict, criterior, optimizer, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        torch.backends.cudnn.benchmark = True      #Tăng tốc tính toán
...
# Cài đặt hàm update tham số của các layer trong mạng
def params_to_update(net):
    params_to_update_1 = []
    params_to_update_2 = []
    params_to_update_3 = []

    update_param_name_1 = ["features"]      # đoạn trước của mạng, phần trước classifier
